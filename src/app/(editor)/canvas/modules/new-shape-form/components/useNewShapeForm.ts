...
import { isRectangleShape, SHAPE_TYPE_RECTANGLE } from "@/app/(editor)/canvas/modules/shapes/components/rectangle/consts"
import { useCanvas } from "@/app/(editor)/canvas/context"
import { DEFAULT_SHAPE_COLOR } from "@/app/(editor)/canvas/modules/shapes/consts"
